...
export const SAMPLE_NOTIFICATIONS: Notification[] = [
  {
    ...
    message:    'Successfully processed 12 refund requests from Shopify. All customers notified via email.',
    severity:   'success',
    category:   'agent',
  ...
  },
  {
    ...
    message:    'Could not retrieve tickets from Zendesk — API rate limit exceeded. Retrying in 15 minutes.',
    severity:   'error',
    category:   'agent',
