    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 flex justify-center pb-10 px-6">
      <div className="relative w-full max-w-2xl" style={PIXEL_BORDER} onClick={advance}>
        ...
        <div
          ...
          style={{ top: '-28px', ...PIXEL_BORDER_SM, background: '#1a0e06' }}
        >
          <span
        ...
        >
          ...
          <p
            ...
            style={{ fontFamily: '"Courier New", Courier, monospace', color: '#f0e0c0' }}
          >
            {displayedText}
            {!isComplete && (
              <span
        ...
        <div
          ...
          style={{ background: '#140a04', borderTop: '2px solid #0d0705' }}
        >
