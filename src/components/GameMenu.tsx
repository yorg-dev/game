                  ...
                  {connections.length === 0 ? (
                    ...
                    connections.map((conn) => {
                      ...
                      return (
                        ...
                        >
                          <span
                            className="w-2.5 h-2.5 rounded-full shrink-0 border border-[#7a5230]/30"
                            style={{ background: app?.color ?? '#9a6b28' }}
                          />
                          <span className="flex-1 text-sm font-bold text-[#3d2010] truncate">
                            {app?.name ?? conn.appId}
                          </span>
                          <span className="text-[11px] font-bold text-[#9a6b28] truncate max-w-[5rem] shrink-0">
                            {conn.label}
                          </span>
                          <span
